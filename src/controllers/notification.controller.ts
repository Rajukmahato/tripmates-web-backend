...
import { RegisterTokenDto } from "../dots/notification.dto";
...
export class NotificationController {
    ...
    async registerToken(req: Request, res: Response) {
        try {
            ...
            const validatedData = RegisterTokenDto.parse(req.body);
    ...
    async getNotifications(req: Request, res: Response) {
        try {
            ...
            res.status(200).json({
                ...
                data: result.notifications, // Array
                pagination: { page: result.currentPage, limit, total: result.total, pages: result.pages },
